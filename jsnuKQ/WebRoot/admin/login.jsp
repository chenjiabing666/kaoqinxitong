...
<link href="/jsnuKQ/admin/css/login.css" rel="stylesheet" />
</head>
...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-4" id="col">
				<form role="form" method="post" action="/jsnuKQ/admin/login">
					<div class="form-group">
						<label for="name">教工号</label> <input type="text"
							class="form-control" name="admin.teacherId" id="name"
							placeholder="请输入教工号"> <span class="text-danger"
							id="stIDerror" style="font-size: 18px;"><s:property
								value="errors.IdError[0]" /></span>
					</div>

					<div class="form-group" id="pwDiv">
						<label for="pw">密码</label> <input type="password"
							class="form-control" name="admin.password" id="pw"
							placeholder="请输入密码"> <span class="text-danger"
							style="font-size: 18px;"><s:property
								value="errors.pwError[0]" /></span>
					</div>

					<button type="submit" class="btn btn-default btn-danger"
						id="btn-submit">登录</button>
					<button type="button" class="btn btn-default btn-danger pull-right"
						onclick="change()">注册</button>
				</form>
	...
	<script>
		...
		function change() {
			var $form = $("form");
			$form.attr("action", "/jsnuKQ/admin/regist.jsp");
			$form.submit();
		}
	</script>
